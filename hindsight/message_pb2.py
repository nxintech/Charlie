...
_FIELD.fields_by_name['value_integer']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(),
                                                                            _b('\020\001'))
_FIELD.fields_by_name['value_double'].has_options = True
_FIELD.fields_by_name['value_double']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(),
                                                                           _b('\020\001'))
